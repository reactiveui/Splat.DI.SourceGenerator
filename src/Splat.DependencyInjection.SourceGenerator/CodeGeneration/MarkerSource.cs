...
/// <summary>The fixed source every consumer gets: the marker methods and the injection attributes.</summary>
internal static class MarkerSource
{
    /// <summary>The assembly name of the source generator, used in GeneratedCodeAttribute.</summary>
    private static readonly AssemblyName GeneratorAssemblyName = typeof(MarkerSource).Assembly.GetName();

    /// <summary>Gets the marker methods and attributes, built once per generator load.</summary>
    internal static string Text { get; } = $$"""
        ...
        namespace {{Constants.NamespaceName}}
        {
            ...
            /// </summary>
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("{{GeneratorAssemblyName.Name}}", "{{GeneratorAssemblyName.Version}}")]
