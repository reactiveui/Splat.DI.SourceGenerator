        ...
        {
            {
                ...
                Splat.Locator.CurrentMutable.Register(() => lazy, typeof(global::System.Lazy<Test.ITest1>), "Test2");
                Splat.Locator.CurrentMutable.Register(() => lazy.Value, typeof(global::Test.ITest1), "Test2");
            }
            {
                ...
                Splat.Locator.CurrentMutable.Register(() => lazy, typeof(global::System.Lazy<Test.ITest2>), "Test2");
                Splat.Locator.CurrentMutable.Register(() => lazy.Value, typeof(global::Test.ITest2), "Test2");
            }
            {
                ...
                Splat.Locator.CurrentMutable.Register(() => lazy, typeof(global::System.Lazy<Test.ITest3>), "Test2");
                Splat.Locator.CurrentMutable.Register(() => lazy.Value, typeof(global::Test.ITest3), "Test2");
            }
        }
    }
}